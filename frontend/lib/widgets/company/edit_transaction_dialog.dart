...
class _EditTransactionDialogState extends ConsumerState<EditTransactionDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveAmount = showAmountField ? _amount : _selectedProducts.fold(0.0, (sum, item) => sum + (item['total'] as double));
            ...
            child: Column(
              ...
              children: [
                      ...
                      child: SegmentedButton<String>(
                        style: ButtonStyle(
                          ...
                          backgroundColor: WidgetStateProperty.resolveWith((states) {
                            if (states.contains(WidgetState.selected)) return colorScheme.primary.withOpacity(0.2);
                ...
                if (_selectedProducts.isNotEmpty) ...[
                  const SizedBox(height: 8),
                  Text('${t.totalLabel}: ${effectiveAmount.toStringAsFixed(2)}$currency', style: TextStyle(fontWeight: FontWeight.bold, color: colorScheme.onSurface)),
                ],
                const SizedBox(height: 12),
                ListTile(
