...
def main():
    ...
    permissions = [
        ...
        ('view_production', 'Просмотр производства'),
        ('create_production', 'Создание производственных записей'),
        ('edit_production', 'Редактирование производственных записей'),
        ('delete_production', 'Удаление производственных записей'),
        ('manage_manufactured_products', 'Управление производимыми товарами'),
    ]
