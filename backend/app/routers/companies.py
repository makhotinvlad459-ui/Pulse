...
async def delete_company(
    ...
    # ✅ 1. Удаляем платежи по заказам (order_payments)
    await db.execute(
    ...
    # ✅ 2. Находим все продукты компании
